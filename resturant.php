...
<div class="endcorosal py-5" id="Rally">
     <div class="text-center wow bounceInUp" data-wow-delay="0.1s">
                <small
                    class="d-inline-block fw-bold text-primary text-uppercase bg-transparent border border-bottom-primary rounded-pill px-4 py-1 mb-3">Resturants</small>
                <h1 class="display-5 mb-5 font-blue text-headding">Explore Partners Resturants </h1>
            </div>
